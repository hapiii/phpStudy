...
if( $do== "delete"){
    $id = $_GET['id'];
    $result = $conn->query("delete from votename where cid in ($id);");
    if($result){
...
if($sub){
    ...
    $result = $conn->query("update votename set question_name='$question_name' where cid='$id';");
    if($result){
...
<div class="div_from_aoto" style="width: 800px; margin:30px 40px;">
    ...
    <form name="form1" method="post" action="">
        <table width="500" border="0" cellspacing="0" cellpadding="0">
            ...
            <?php
            $result = mysqli_query($conn,"select * from votename;");
    ...
    if($do1== "change"){
        $id = $_GET['id'];
        $result = mysqli_query($conn,"select * from votename where cid='$id';");
